...
void Mega::init()
{
  ...
  barillet = Barillet(BARILLET_PIN_CONTACTEUR, BARILLET_PIN_CODEUSE_A, BARILLET_PIN_CODEUSE_B, BARILLET_TickToPos, BARILLET_PIN_MOTEUR_PWR, BARILLET_PIN_MOTEUR_SENS,BARILLET_PIN_MOTEUR_BRAKE, this);
